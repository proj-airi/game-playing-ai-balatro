...
def main():
    ...
    print("🃏 Balatro Action Module Demo")
    print("=" * 50)
    ...
    try:
        ...
        # 5. 演示模式选择
        print("\n5. 选择演示模式:")
        print("   1. 出牌示例 [1, 1, 1, 0] - 选择前三张牌出牌")
        print("   2. 弃牌示例 [-1, -1, 0, 0] - 弃掉前两张牌")  
        print("   3. 悬停示例 - 查看第一张牌的详情")
        print("   4. 自定义位置数组")
        print("   5. 可视化测试 - 带预览窗口的操作")
        print("   6. 鼠标移动测试 - 测试平滑移动效果")
        print("   7. 退出")
        ...
        while True:
            try:
                ...
                if choice == '1':
                    ...
                    # 可视化测试
                    print("\n🖼️  可视化测试模式")
                    print("   提示: 会弹出预览窗口，显示即将执行的操作")
                    print("   选择测试操作:")
                    print("     a. 可视化出牌 [1, 1, 0, 0]")
                    print("     b. 可视化弃牌 [-1, -1, 0, 0]")
                    print("     c. 返回主菜单")
...
def show_usage():
    ...
    print()
    print("📝 示例:")
    print("   [1, 1, 1, 0]    # 选择前三张牌出牌")
    print("   [-1, -1, 0, 0]  # 弃掉前两张牌")

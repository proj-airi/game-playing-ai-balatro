...
class PromptTemplate:
    ...
    def add_section(
        ...
        section = TemplateSection(
            name=name, content=content, required=required, conditions=conditions or []
        )
    ...
    def _should_include_section(
        self, section: TemplateSection, context: Dict[str, Any]
    ) -> bool:
...
class PromptTemplateManager:
    ...
    def _register_default_templates(self):
        ...
        planning_template.add_section(
            'objective', 'OBJECTIVE: {objective}', required=False
        )
        planning_template.add_section(
            'request',
        ...
        execution_template.add_section(
            'decision', 'PLANNED ACTION: {planned_action}', required=False
        )
        execution_template.add_section(

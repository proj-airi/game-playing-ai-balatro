...
from src.ai_balatro.ai.actions.card_actions import CardActionEngine, CardPositionDetector
...
class TestCardPositionDetector:
    ...
    def test_filter_playable_cards(self):
        ...
        detections = [
            ...
            Detection(3, "poker_card_back", 0.6, (300, 100, 350, 200)),  # 背面，非可玩牌
...
class TestGameActionSchemas:
    ...
    def test_select_cards_schema(self):
        ...
        action = next(a for a in GAME_ACTIONS if a["name"] == "select_cards_by_position")

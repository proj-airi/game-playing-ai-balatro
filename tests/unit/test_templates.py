...
class TestPromptTemplate:
    ...
    def test_condition_evaluation(self):
        ...
        template.add_section(
            'conditional1', 'Exists: {var1}', conditions=['var_exists:var1']
        )
        ...
        template.add_section(
            'conditional3', 'Not empty: {var3}', conditions=['var_not_empty:var3']
        )

        # Test with conditions met
        context = {'var1': 'present', 'var2': 'test_value', 'var3': 'not empty'}
        result = template.render(context)
        ...
        context_fail = {'var2': 'wrong_value', 'var3': ''}
...
class TestDefaultTemplates:
    ...
    def test_template_with_optional_sections(self):
        ...
        context_minimal = {'game_state_summary': 'Basic state', 'card_list': ['Card 1']}
